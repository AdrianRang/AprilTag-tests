...
public final class Constants {
  ...
  public static class FieldConstants {
    public static final double kInitialPoseX = 0.0;
    public static final double kInitialPoseY = 0.0;
    public static final double kInitialPoseRotation = 0.0; // In radians
    public static final Pose2d kInitialPose = new Pose2d(kInitialPoseX, kInitialPoseY, new Rotation2d(kInitialPoseRotation));
  }
